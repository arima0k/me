  ...
  return (
    <header className={clsx('hero hero--primary', styles.heroBanner)}>
      <div className="container">
        ...
        <h2 className="hero__subtitle">This my personal website under a subdomain of one of my domains that I use for various projects.</h2>
        ...
        <header className={clsx('hero hero--primary', styles.aboutBanner)}>
            <div className="container">
                ...
                <p className="hero__subtitle">I'm Luis (I also use the nicknames <b>"arima0k | angw97"</b>).
                    <br />
                    I'm an autodidact guy who likes technology.
                    <br />
                ...
                <p className="hero__subtitle">Some of my skill are: Inquisitive, intuitive, self-taught,
                    logical thinking, quick learning and versatile.
                    <br />
